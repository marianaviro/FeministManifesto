var sixteenthPrinciple = function(s) {
  ...
  s.draw = function() {
    ...
    let rectangleCenterX = rectangleX + rectangleWidth/2;
    let rectangleCenterY = rectangleY + rectangleHeight/2;
    let radius = rectangleHeight - 3;
    s.ellipse(rectangleCenterX,rectangleCenterY,radius, radius);
  ...
  s.down = function() {
    s.select('#seventeenth').show();
    s.select('#sixteenth').hide();
  };

}

var sixteenth = new p5(sixteenthPrinciple, 'sixteenth');
